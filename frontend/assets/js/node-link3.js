function nodeLink3(data) {
  ...
  svg.append("defs").append("marker")
    ...
    .attr("fill", "#000");            // Color of the arrow
  ...
  // Restore the simulation when drag starts, and fix the subject position.
  ...
  function highlightNode(d) {
    ...
    linkLabels.attr("fill", l => (l.source === d || l.target === d) ? "red" : color(node.group));
  }
